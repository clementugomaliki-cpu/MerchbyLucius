        ...
        <div className="grid grid-cols-2 ">
            ...
            <div className="flex flex-col justify-center items-center px-24 gap-8 mx-auto">
                ...
                <div className="flex flex-col items-center text-center px-16">
                    ...
                    <Link className="rounded-full flex items-center justify-center bg-[#2EC5BC] px-30 py-3 mb-4 font-semibold text-white cursor-pointer hover:opacity-[0.85]">Go to Dashboard</Link>
                </div>
            </div>
        </section>
    )
