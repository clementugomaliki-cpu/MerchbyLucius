      ...
      <div className="bg-[#F8FAFB] flex gap-6">
        ...
        <div className="flex-1 min-h-screen mt-24 md:ml-72 px-4 sm:px-8 md:px-12 py-8">
          ...
          <div className="hidden md:flex gap-3 py-8">
            <button className={`px-6 py-2 rounded-full text-sm font-semibold text-[#3C4948] ${activeTab === "all" ? "bg-[#2EC5BC] text-white" : "bg-gray-200"}`}>All</button>
            <button onClick={()=>setActiveTab("interactive")}
                className={`px-6 py-2 rounded-full text-sm font-semibold text-[#3C4948] ${activeTab === "interactive" ? "bg-[#2EC5BC] text-white" : "bg-gray-200"}`}>Interactive</button>
            <button onClick={()=>setActiveTab("worksheets")}
                className={`px-6 py-2 rounded-full text-sm font-semibold text-[#3C4948] ${activeTab === "worksheets" ? "bg-[#2EC5BC] text-white" : "bg-gray-200"}`}>Worksheets</button>
            <button onClick={()=>setActiveTab("videos")}
                className={`px-6 py-2 rounded-full text-sm font-semibold text-[#3C4948] ${activeTab === "videos" ? "bg-[#2EC5BC] text-white" : "bg-gray-200"}`}>Videos</button>
            <button onClick={()=>setActiveTab("bundles")}
                className={`px-6 py-2 rounded-full text-sm font-semibold text-[#3C4948] ${activeTab === "bundles" ? "bg-[#2EC5BC] text-white" : "bg-gray-200"}`}>Bundles</button>
          </div>
         
          <div className="md:flex gap-6 mt-10 md:mt-0">
